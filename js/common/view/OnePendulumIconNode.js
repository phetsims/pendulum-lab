...
define( function( require ) {
  ...
  var RECT_GRADIENT = new LinearGradient( 0, 0, RECT_WIDTH, 0 ).addColorStop( 0, PendulumLabConstants.FIRST_PENDULUM_COLOR ).addColorStop( 0.8, 'white' ).addColorStop( 1, PendulumLabConstants.FIRST_PENDULUM_COLOR );
